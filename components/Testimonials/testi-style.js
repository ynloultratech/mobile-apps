...
import decoLightBottom from '~/static/images/mobile/deco-light-top.svg';
import decoDarkBottom from '~/static/images/mobile/deco-dark-top.svg';
...
const testiStyles = makeStyles(theme => ({
  root: {
    ...
    minHeight: 400,
    paddingTop: props => props.merchantInfo && props.merchantInfo.type !== 'dealer' ? theme.spacing(60) : theme.spacing(22),
